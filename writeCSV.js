const ingArr = [
  ...
  "smoked paprika",
  "tahini",
  "water + more for dressing",
  "dinosaur kale",
  "dried sage",
  "dried thyme",
  "milk",
  "nutmeg",
  "Lasagna Sheets (7\"x3.5\") Pre Cooked Dry",
  "marinated artichoke hearts",
  "Sfoglini whole-grain radiator pasta",
  "cream cheese",
  "pumpkin ravioli",
  "oregano and parsley",
  "Yukon Gold potatoes",
  ...
  "small round aluminum tins",
  "large square aluminum tin",
  "gnocchi",
  "onion powder",
  "ground turmeric",
  ...
  "bay leaf",
  "14-ounce cans whole peeled tomatoes",
  "dry sherry",
  "raspberry preserves",
  "edamame",
  "yellow squash",
  ...
  "Chicken Wings (2 joint party wings ~1.5-LB/ 10 each )",
  "tomato",
  "sliced dill pickle",
  ...
  "whole milk",
  "Skewer Wooden (6\")",
  "water + more for skewers and vegetables",
  "celery seed",
  "pita bread",
  ...
  "dill and thyme",
  "jar ketchup",
  "ají panca chile powder ",
  "lima beans",
  "wood skewers",
  "fresh spaghetti",
  "mini marshmallows",
  "8-inch squares matzoh",
...
function repeatArr(arr) {
  return arr.map( (el) => {
    ...
    return `"${lowerEl}"`.concat(',', `"${lowerEl}"`, '\n');
  })
}
const fs = require('fs');

const finalArr = repeatArr(ingArr);
fs.writeFile('dialogflowIngredients.csv', finalArr, 'utf8', function(err) {
  if (err) {
